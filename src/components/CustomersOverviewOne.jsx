...
const CustomersOverviewOne = () => {
  const { invoices } = useSelector((state) => state.invoices);
  const freshSale = invoices.filter(invoice => invoice.sale_type === 'fresh sale').length;
  const upsell = invoices.filter(invoice => invoice.sale_type === 'upsell').length;
  const recurring = invoices.filter(invoice => invoice.sale_type === 'recurring').length;
...
export default CustomersOverviewOne;