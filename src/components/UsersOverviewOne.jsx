...
const UsersOverviewOne = (filter) => {
  ...
  const freshSale = data.filter(invoice => invoice.sale_type === 'fresh sale').length;
  const upsell = data.filter(invoice => invoice.sale_type === 'upsell').length;
  const recurring = data.filter(invoice => invoice.sale_type === 'recurring').length;
